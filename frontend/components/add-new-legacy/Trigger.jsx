      ...
      <div className="p-8 md:p-12 md:w-3/5 bg-slate-900/30">
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <motion.div
            ...
            className="relative"
          >
            <label className="block text-slate-400 text-sm font-medium mb-2">Trigger Type</label>
            <select
              value={type}
          ...
          {type === "scheduled" && (
            ...
            >
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-slate-900/80 border border-slate-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 transition-all shadow-inner"
              />
            </motion.div>
          )}
